...
upper_cascade = cv.CascadeClassifier('haarcascades/haarcascade_upperbody.xml')
lower_cascade = cv.CascadeClassifier('haarcascades/haarcascade_lowerbody.xml')
img = cv.imread('image/2.webp')
